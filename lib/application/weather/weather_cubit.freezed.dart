...
return loaded(_that.weather);case _Error() when error != null:
...
return loaded(_that.weather);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class _Loaded implements WeatherState {
  const _Loaded(this.weather);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.weather, weather) || other.weather == weather));
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $WeatherStateCopyWith<$Res> {
